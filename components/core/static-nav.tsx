    ...
    <NavigationMenu>
      <NavigationMenuList>
        <NavigationMenuItem>
          <Link
            href={"#"}
            className={`text-${color} hover:text-${color} inline-flex h-10 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium transition-colors`}
          >
            Home
          </Link>
        </NavigationMenuItem>
